...
export class InvoiceItem {
  ...
  @Column({ name: 'gross_value', type: 'decimal', precision: 15, scale: 2, default: 0, transformer: decimalTransformer })
  grossValue!: number;

  @Column({ name: 'qtde_item', type: 'decimal', precision: 15, scale: 4, default: 0, transformer: decimalTransformer })
  qtdeItem!: number;

  @Column({ name: 'unit_value', type: 'decimal', precision: 21, scale: 10, default: 0, transformer: decimalTransformer })
  unitValue!: number;
  ...
  @Column({ name: 'icmsst_value', type: 'decimal', precision: 15, scale: 2, default: 0, transformer: decimalTransformer })
  icmsstValue!: number;

  @Column({ name: 'icmsdeson_value', type: 'decimal', precision: 15, scale: 2, default: 0, transformer: decimalTransformer })
  icmsdesonValue!: number;

  @Column({ name: 'fcpst_value', type: 'decimal', precision: 15, scale: 2, default: 0, transformer: decimalTransformer })
  fcpstValue!: number;

  @Column({ name: 'bc_icms_value', type: 'decimal', precision: 15, scale: 2, default: 0, transformer: decimalTransformer })
  bcIcmsValue!: number;

  @Column({ name: 'aliq_icms_value', type: 'decimal', precision: 5, scale: 2, default: 0, transformer: decimalTransformer })
