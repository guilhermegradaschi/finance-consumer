...
import { IngestNfeProviderDto } from '@context/ingestion/infrastructure/http/dto/ingest-nfe-provider.dto';
import { IngestNfeEventDto } from '@context/ingestion/infrastructure/http/dto/ingest-nfe-event.dto';
...
export class IngestNfeController {
  ...
  async provider(@Body() body: IngestNfeProviderDto, @Headers('x-correlation-id') correlationHeader?: string) {
