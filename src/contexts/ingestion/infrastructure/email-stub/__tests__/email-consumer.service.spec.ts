...
describe('EmailConsumerService', () => {
  ...
  const xmlContent =
    '<infNFe Id="NFe35240112345678000195550010000001231234567890" versao="4.00"><nNF>123</nNF></infNFe>';
  ...
  function buildConfigGet(overrides: Record<string, unknown> = {}) {
    ...
    return (key: string, fallback?: unknown) => (merged[key] !== undefined ? merged[key] : fallback);
  }
