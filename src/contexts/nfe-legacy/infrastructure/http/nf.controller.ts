...
import { SubmitNfMultipartFieldsDto } from '@context/nfe-legacy/infrastructure/http/dto/submit-nf-multipart.dto';
import { QueryNfDto } from '@context/nfe-legacy/infrastructure/http/dto/query-nf.dto';
import { QueryNfAuditDto } from '@context/nfe-legacy/infrastructure/http/dto/query-nf-audit.dto';
import { QueryNfAuditEventsDto } from '@context/nfe-legacy/infrastructure/http/dto/query-nf-audit-events.dto';
...
export class NfController {
  ...
  async submit(@UploadedFile() file: UploadedXmlFile | undefined, @Body() fields: SubmitNfMultipartFieldsDto) {
