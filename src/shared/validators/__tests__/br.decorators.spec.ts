...
import { IsCnpj, IsCpf, IsChaveNFe, IsIe } from '@shared/validators/br.decorators';
...
describe('br.decorators', () => {
  ...
  it('should validate chave NFe on DTO', () => {
    expect(
      validateSync(Object.assign(new ChaveDto(), { chave: '35240112345678000195550010000001231234567891' })),
    ).toHaveLength(0);
    expect(
      validateSync(Object.assign(new ChaveDto(), { chave: '35240112345678000195550010000001231234567890' })).length,
    ).toBeGreaterThan(0);
  });
