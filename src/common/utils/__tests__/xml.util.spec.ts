import { extractChaveAcessoFromXml, isValidChaveAcesso, extractXmlTag } from '../xml.util';
...
describe('xml.util', () => {
  describe('extractChaveAcessoFromXml', () => {
    ...
    it('should extract chaveAcesso from single-line real NF-e XML', () => {
      const xml = '<?xml version="1.0" encoding="UTF-8" ?><nfeProc versao="4.00" xmlns="http://www.portalfiscal.inf.br/nfe"><NFe xmlns="http://www.portalfiscal.inf.br/nfe"><infNFe Id="NFe35260328189078000115550010011243241110120258" versao="4.00"><ide><cUF>35</cUF></ide></infNFe></NFe></nfeProc>';
      const result = extractChaveAcessoFromXml(xml);
      expect(result).toBe('35260328189078000115550010011243241110120258');
    });
  });
